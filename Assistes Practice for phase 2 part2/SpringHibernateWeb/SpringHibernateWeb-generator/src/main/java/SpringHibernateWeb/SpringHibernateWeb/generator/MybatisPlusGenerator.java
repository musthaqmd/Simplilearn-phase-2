package SpringHibernateWeb.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "SpringHibernateWeb";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/SpringHibernateWeb-model"),
        mapper("/SpringHibernateWeb-dao"),
        mapperxml("/SpringHibernateWeb-web"),
        service("/SpringHibernateWeb-service"),
        web("/SpringHibernateWeb-web"),
        ;
